  ...
  render() {
    return (
      <div className="player" onClick={() => {this.handleClick()}} data-alive={this.props.alive ? 1 : 0} data-active={this.props.active ? 1 : 0} data-attacking={this.props.attacking ? 1 : 0} data-attacked={this.props.attacked ? 1 : 0}>
        ...
        <div className="hp"><i className="fa fa-heart" aria-hidden="true"></i> HP: {Complex(this.props.hp).str}</div>
        <div className="special"><i className="fa fa-fire" aria-hidden="true"></i> 特殊技: {this.props.special}</div>
